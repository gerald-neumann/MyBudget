...
import { restoreLastShellRouteGuard } from './core/restore-last-shell-route.guard';
    ...
    children: [
      {
        path: '',
        pathMatch: 'full',
        canActivate: [restoreLastShellRouteGuard],
        component: RestoreLastShellRouteComponent
      },
