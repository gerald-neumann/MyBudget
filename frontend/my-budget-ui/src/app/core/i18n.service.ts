...
const translations: Record<LanguageCode, Record<string, string>> = {
  de: {
    ...
    'app.shellLoading': 'Arbeitsbereich wird geladen …',
    ...
    'app.workspaceMenuAria': 'Budgets anlegen und verwalten',
    ...
    'app.sampleWatermarkHint': 'Du siehst den Beispielhaushalt mit Demo-Daten, nicht deine echten Finanzen.',
    ...
    'help.toolbarTitle': 'Kopfzeile: Budget-Arbeitsbereich',
    'help.toolbarBody':
      'Wähle die Baseline (euer Budget-Arbeitsbereich). Drei Symbole rechts: Budgets (anlegen, ableiten, umbenennen, Standard), Zugriff (beitreten, teilen, gesendete Einladungen) und Konto (Sprache, Hilfe, Abmelden; mit Keycloak läuft dort ein Countdown zur Token-Gültigkeit). Das Kalenderjahr stellst du auf Dashboard, Budget- und Ist-Seite ein.',
    ...
    'help.sharingBody':
      'Nur der Owner kann andere einladen. Editor dürfen Budget und Istbuchungen ändern; Viewer lesen mit. Einladungen erzeugst und verwaltest du über das Zugriff-Symbol (Freigaben, gesendete Einladungen).',
    'help.workflowTitle': 'Typischer Ablauf',
    'help.workflowBody':
      '1) Baseline wählen; das Kalenderjahr stellst du auf Dashboard, Budget- und Ist-Seite ein.\n2) Unter „Budgets" Kategorien und Positionen anlegen und den Monatsplan pflegen.\n3) Konten unter „Konten" prüfen oder anlegen.\n4) Ist-Zahlungen unter „Einnahmen & Ausgaben" erfassen und bei Bedarf in der Liste anpassen.\n5) Auswertung im „Dashboard" vergleichen.',
    ...
    'budget.subtitle':
      'Zeilen sind Positionen (in der Tabelle nur der Name), nach Kategorie als Abschnitte gruppiert. Monatsspalten sind das konkrete Jahr. „Bearbeiten“ oder Zeilenklick öffnet den Dialog (Rhythmus, Zeitraum, Vorlagebetrag, Kategorie, Raster-Optionen). Monatsbeträge änderst du direkt in der Tabelle; Positionsnamen einmaliger Zeilen ebenfalls in der Zeile. Einnahmen (+), Ausgaben (−). Änderungen werden gespeichert.',
    ...
    'budget.amountHintIncome': 'Positiver Betrag',
    'budget.amountHintExpense': 'Positiver Betrag (wird als Ausgabe gebucht)',
  ...
  en: {
    ...
    'app.dashboard': 'Dashboard',
    'app.shellLoading': 'Loading your workspace…',
    ...
    'app.workspaceMenuAria': 'Create and manage budgets',
    ...
    'app.sampleWatermarkHint': 'You are viewing the example household with demo data, not your real finances.',
    ...
    'help.toolbarTitle': 'Header: workspace',
    'help.toolbarBody':
      'Pick the baseline (your budget workspace). Three icons on the right: budgets (create, fork, rename, default), access (join with a token, sharing, invitations you sent), and account (language, help, sign out; with Keycloak a live countdown shows access-token validity). Set the calendar year on Dashboard, Budget, or Income & spending.',
    'help.dashboardTitle': 'Dashboard',
    'help.dashboardBody':
    ...
    'help.budgetBody':
      'Maintain positions and planned month amounts for the selected year. Rows are grouped by category. Use Edit or row click to open the dialog for cadence, date range, template amount, and category; recurring months can be reset to the template. Edit month cells and one-off position names directly in the grid (income positive, spending negative); cell changes autosave.',
    ...
    'budget.subtitle':
      'Each row is a position (only the name appears in the grid), grouped under category section headers. Month columns are the selected year. “Edit” or row click opens the dialog (cadence, date range, template amount, category, planned-cell options). Edit month amounts and one-off position names in the grid. Income (+), spending (−). Edits autosave.',
    ...
    'budget.amountHintIncome': 'Positive amount',
    'budget.amountHintExpense': 'Positive amount (booked as expense)',
