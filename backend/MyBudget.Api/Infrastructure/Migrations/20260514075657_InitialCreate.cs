        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type_label = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_primary_budget = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    is_sample_demo = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sort_order = table.Column<int>(type: "integer", nullable: false),
                    recurrence_rule_json = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_actual_entries_accounts_account_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_actual_entries_account_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ux_baselines_user_id_primary_budget",
                table: "baselines",
                column: "user_id",
                unique: true,
                filter: "is_primary_budget IS TRUE");
