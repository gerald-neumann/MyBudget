...
const translations: Record<LanguageCode, Record<string, string>> = {
  de: {
    ...
    'app.tableDensity': 'Tabellenabstand',
    'app.tableDensity.comfortable': 'Normal',
    'app.tableDensity.condensed': 'Kompakt',
  ...
  en: {
    ...
    'app.tableDensity': 'Table spacing',
    'app.tableDensity.comfortable': 'Comfortable',
    'app.tableDensity.condensed': 'Compact',
